...
def run_turtle_backtest(
    *,
    ...
    cfg = TurtleConfig(
        ...
        expansion_min_growth=expansion_min_growth,
        breakout_entry_fraction=breakout_entry_fraction,
        use_trend_strength_layering=use_trend_strength_layering,
        strong_trend_threshold=strong_trend_threshold,
        weak_exit_lookback=weak_exit_lookback,
        strong_exit_lookback=strong_exit_lookback,
        weak_pullback_tolerance_atr=weak_pullback_tolerance_atr,
        strong_pullback_tolerance_atr=strong_pullback_tolerance_atr,
        weak_trend_pullback_only=weak_trend_pullback_only,
        weak_trend_no_trade=weak_trend_no_trade,
        add_on_only_after_profit=add_on_only_after_profit,
        addon_min_unrealized_r=addon_min_unrealized_r,
        min_breakout_distance_atr=min_breakout_distance_atr,
        min_breakout_body_atr=min_breakout_body_atr,
        ...
        min_signal_score_ratio=min_signal_score_ratio,
        min_position_scale=min_position_scale,
        follow_through_bars=follow_through_bars,
        follow_through_max_wait_bars=follow_through_max_wait_bars,
        max_hold_bars=max_hold_bars,
        use_htf_filter=use_htf_filter,
        htf_entry_lookback=htf_entry_lookback,
        htf_expansion_bars=htf_expansion_bars,
        htf_expansion_min_growth=htf_expansion_min_growth,
        htf_require_channel_expansion=htf_require_channel_expansion,
        rp_turnover_window=rp_turnover_window,
        rp_base_turnover=rp_base_turnover,
        rp_max_turnover_cap=rp_max_turnover_cap,
        rp_entry_confirm_bars=rp_entry_confirm_bars,
        rp_exit_confirm_bars=rp_exit_confirm_bars,
        rp_entry_band_atr=rp_entry_band_atr,
        rp_exit_band_atr=rp_exit_band_atr,
        rp_min_hold_bars=rp_min_hold_bars,
        rp_htf_slope_bars=rp_htf_slope_bars,
        use_rp_chop_filter=use_rp_chop_filter,
        rp_slope_bars=rp_slope_bars,
        rp_min_slope_ratio=rp_min_slope_ratio,
        rp_min_atr_ratio=rp_min_atr_ratio,
        use_rp_signal_quality_sizing=use_rp_signal_quality_sizing,
        rp_quality_target_atr=rp_quality_target_atr,
        rp_quality_min_scale=rp_quality_min_scale,
        use_regime_filter=use_regime_filter,
        regime_ema_window=regime_ema_window,
        regime_slope_bars=regime_slope_bars,
        regime_min_slope=regime_min_slope,
